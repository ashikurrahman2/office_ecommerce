                ...
                <div class="card card-container">
                    @if ($loop->first)
                        <div class="card-header d-none d-md-flex">
                            ...
                            <div class="col-md-4">Warehouse Details</div>
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="mb-1">
                                ...
                                @if ($item->status == 'pending')
                                    <span class="badge badge-primary status-style">In review</span>
                ...
                <div class="card card-container">
                    ...
                    <div class="card-body row">
                        <div class="col-md-6">
                            ...
                            <p class="mb-1">
                                <strong>Status:</strong>
                                <span class="badge badge-success status-style">Approved and move to Forwording </span>
