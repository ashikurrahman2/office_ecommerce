                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($order->payment_status == 'paid')
                                        <span class="badge badge-inline badge-success py-1 fs-12">{{translate('Partially Paid')}}</span>
                                    
                                    @elseif($order->payment_status == 'fullpaid')
                                        <span class="badge badge-inline badge-info">{{translate('Paid')}}</span>
                                    @else
                                        <span class="badge badge-inline badge-danger  py-1 fs-12">{{translate('Unpaid')}}</span>
                                    @endif
                                </td>
                                <td >
                                     @php $delivery_status = translate(ucfirst(str_replace('_', ' ', $order->status)));@endphp
                                  <span class="badge badge-inline badge-primary  py-1 fs-12">{{$delivery_status}}<span>
                                </td>
                                <!-- Options -->
