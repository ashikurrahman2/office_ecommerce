...
.flag-box {
    background-color: #f5ebe8; /* light neutral background */
    padding: 6px 12px;
    border-radius: 4px;
    font-weight: 500;
    display: inline-flex;
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        ...
                        <!-- Product Details -->
                            ...
                            <div class="m-2 ml-4">
                                 <p class="mb-1"><strong>Minimum Order Quantity (MOQ):</strong> <span>{{$minQuantity}} Pcs</span></p>
                                 <p class="mb-1 "><strong>Approximate Weight:</strong> <span
                                        class="total_weight">{{ $detailedProduct['ActualWeightInfo']['Weight'] }}</span> KG</p>
                        <span class="text-danger">*** উল্লেখিত পণ্যের ওজন সম্পূর্ণ সঠিক নয়, এটি আনুমানিক। বাংলাদেশে পৌঁছানোর পর পণ্যের প্রকৃত ওজন মেপে শিপিং চার্জ নির্ধারণ করা হবে।</span>
                         ...
                         @php
                                        ...
                                        <div class="row  row-cols-2 g-3">
                                            ...
                                            <div class="col">
                                                <div class="shipping-option cursor-pointer p-1 bg-light border rounded h-100 active border-primary shadow"
                                                    ...
                                                    <p class=" mb-0" style="font-size: 14px;">৳{{ number_format($airCost) }} /kg</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="shipping-option cursor-pointer p-1 bg-light border rounded h-100"
                                                    ...
                                                    <p class="mb-0" style="font-size: 14px;">৳{{ number_format($seaCost) }} /kg</p>
                                                </div>
                                            </div>
                                ...
                                <div class="card mb-3">
                                   ...
                                   <div class="card-body p-3">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-6 fw-semibold ">Product Quantity</div>
                                            <div class="col-6 text-end"><span class="total_quantity">0.00</span></div>
                                        </div>
                                    
                                        <div class="row mb-2">
                                            <div class="col-6 fw-semibold ">Product Price</div>
                                            <div class="col-6 text-end">৳<span class="sub_total_price">0.00</span></div>
                                        </div>
                                    
                                        <div class="row mb-2">
                                            <div class="col-6 fw-semibold ">Shipping Charge</div>
                                            <div class="col-6 text-end shpping_charge">
                                                {{ number_format($airCost, 0) }} / Kg  <span><a href="#" class="text-primary small ml-2" data-toggle="modal" data-target="#shippingModalDetails">Details&gt;</a></span>
                                            </div>
                                        </div>
                                    
                                        <div class="row mb-2">
                                            <div class="col-6 fw-semibold ">Total Cost</div>
                                            <div class="col-6 text-end">
                                                ৳<span class="total_price">0.00</span> + China Local Courier Charge & Shipping Charge
                                            </div>
                                        </div>
                                    
                                        <div class="row mb-2">
                                            <div class="col-6 fw-semibold">Pay now (50%)</div>
                                            <div class="col-6 text-end">৳<span class="pay_now">0.00</span></div>
                                        </div>
                                    
                                        <div class="row">
                                            <div class="col-6 fw-semibold ">Pay on Delivery</div>
                                            <div class="col-6 text-end">
                                                ৳<span class="pay_later">0.00</span> + China Local Courier Charge & Shipping Charge
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border: 1px solid #f3f3f3;">
                                        <div class="c-scrollbar-light overflow-hidden px-5 pt-3 pb-3">
                                            <div class="h-100 d-flex flex-column justify-content-center">
                                                <div class="top-category-slick aiz-carousel" data-items="5" data-xxl-items="5" data-xl-items="5" data-lg-items="4" data-md-items="4" data-sm-items="1" data-xs-items="1" data-arrows="true" data-dots="false" data-autoplay="true" data-infinite="true" data-autoplay-speed="1500">
                                                   @if (!empty($detailedProduct['RelatedGroups'])) 
                                                    @foreach  ($detailedProduct['RelatedGroups'][0]['Items'] as $key => $product)
                                                                ...
                                                                <div class="aiz-card-box h-auto bg-white hov-scale-img" style="border: 1px solid #e7e7e7;">
                                                                    <div class="position-relative h-170px h-sm-170px h-md-200px img-fit overflow-hidden">
                                                                        ...
                                                                        <a href="{{ route('product', $product['Id']) }}" class="d-block h-100">
                                                                            <img class="lazyload mx-auto w-100 has-transition"
                                                                                src="{{ $product['Image']['Small']['Url'] ?? static_asset('assets/img/placeholder.jpg') }}" alt=""
                                                                        ...
                                                                        <div class="absolute-top-right aiz-p-hov-icon">
                                                                            <a href="javascript:void(0)" class="hov-svg-white"
                                                                                onclick="addToWishList('{{ $product['Id'] }}', '{{ $product['Title'] }}', '{{ $product['Image']['Small']['Url'] }}')"
                                                                    ...
                                                                    <div class="p-2 p-md-3 text-left">
                                                                        ...
                                                                        <div class="fs-14 d-flex justify-content-between align-items-center mt-2">
                                                                            <!-- Price -->
                                                                            <div>
                                                                                <span class="fw-700 text-danger">{{ $product['Price']['ConvertedPrice'] ?? 'N/A' }}</span>
                                                                            </div>
