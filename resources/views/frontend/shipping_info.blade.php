                            ...
                            <div class="border bg-white p-4 mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                <input type="radio" name="address_id" value="{{ $address->id }}" @if ($address->set_default || $addresses->count() == 1)
                                                    checked
                                                @endif required>
                                        ...
                                        <div class="col-md-4 p-3 text-right">
                                            <a class="btn btn-sm btn-danger text-white mr-4 rounded-0 px-4" onclick="edit_address('{{$address->id}}')">{{ translate('Change') }}</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 text-center text-md-right">
                                        {{-- <button type="submit" class="btn btn-danger fs-14 fw-700 rounded-0 px-4">{{ translate('Continue to Delivery Info')}}</a> --}}

                                        <button type="submit" class="btn btn-danger fs-14 fw-700 rounded-0 px-4">{{ translate('Continue to Payment')}}</button>
                                    </div>
