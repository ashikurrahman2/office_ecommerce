                    ...
                    <div>
                        <div class="text-dark d-flex align-items-center mb-0">
                            <a href="{{ route('flash-deals') }}"
                                class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-danger animate-underline-primary mr-3">{{ translate('View All Flash Sale') }}</a>
                            <span class=" border-left border-soft-light border-width-2 pl-3">
                                <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                                    class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-danger animate-underline-primary">{{ translate('View All Products from This Flash Sale') }}</a>
                            </span>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ $product_url }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="d-block text-danger fw-700">{{ home_discounted_base_price($flash_deal_product->product) }}</span>
            ...
            <div class="container">
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <!-- Links -->
                        <div class="d-flex">
                            <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-danger animate-underline-primary"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            ...
                            <div
                                ...
                                <h6 class="text-dark mb-3 h-40px text-truncate-2">
                                    <a class="text-reset fw-700 fs-14 hov-text-danger"
                                        ...
                                        <div class="row hov-scale-img">
                                            ...
                                            <div class="col">
                                                <h3
                                                    ...
                                                    <a href="{{ route('customer.product', $classified_product->slug) }}"
                                                        class="d-block text-reset hov-text-danger">{{ $classified_product->getTranslation('name') }}</a>
                                                </h3>
                                                <div class="fs-14 mb-3">
                                                    <span
                                                        class="text-secondary">{{ $classified_product->user ? $classified_product->user->name : '' }}</span><br>
                                                    <span
                                                        class="fw-700 text-danger">{{ single_price($classified_product->unit_price) }}</span>
                                                </div>
                            ...
                            <div
                                ...
                                <div class="position-relative px-3" style="padding-top: 2rem; padding-bottom:2rem;">
                                    ...
                                    <h2 class="fs-14 fw-700 text-dark text-truncate-2 h-40px mt-3 mt-md-4 mb-0 mb-md-3">
                                        <a href="{{ route('shop.visit', $seller->slug) }}"
                                            class="text-reset hov-text-danger" tabindex="0">{{ $seller->name }}</a>
                                    </h2>
                                    <!-- Shop Rating -->
