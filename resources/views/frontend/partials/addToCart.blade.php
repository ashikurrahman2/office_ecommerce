                        ...
                        <div class="col-9">
                            <div class="">
                                ...
                                @if(discount_in_percentage($product) > 0)
                                    <span class="bg-danger ml-2 fs-11 fw-700 text-white w-35px text-center px-2" style="padding-top:2px;padding-bottom:2px;">-{{discount_in_percentage($product)}}%</span>
                                @endif
                            </div>
