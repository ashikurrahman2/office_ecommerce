    ...
    <div class="media mb-1">
        ...
        <div class="media-body mt-2 text-left d-flex flex-column justify-content-between">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-9">
                    <div class="fs-16 fw-700 text-danger">
                        <strong>
                    ...
                    <div class="aiz-card-box my-2 has-transition">
                        ...
                        <div class="p-md-3 p-2 text-center">
                            <h3 class="fw-400 fs-14 text-dark text-truncate-2 lh-1-4 mb-0 h-35px">
                                <a href="{{ route('product', $related_product->slug) }}" class="d-block text-reset hov-text-danger">{{ $related_product->getTranslation('name') }}</a>
                            </h3>
                            <div class="fs-14 mt-2">
                                <span class="fw-700 text-danger">{{ home_discounted_base_price($related_product) }}</span>
