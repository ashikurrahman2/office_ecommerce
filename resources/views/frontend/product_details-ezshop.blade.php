            ...
            <div class="bg-white py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9">
                        <h2 class="fs-16 fw-500 text-dark pb-2 border-bottom">
                        ...
                        <!-- Product Details -->
                            ...
                            @if (!empty($couponDetails))
                                                            ...
                                                            <tr class="configured-item-row"
                                                                ...
                                                                <td>
                                                                    <div class="input-group quantity-group">
                                                                        <button class="btn btn-primary decrement-btn px-2"
                                                                            type="button">-</button>
                                                                        <input type="text"
                                                                            class="form-control text-center quantity-input"
                                                                            value="0" style=" padding: 0;">
                                                                        <button class="btn btn-primary increment-btn px-2"
                                                                            type="button">+</button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                ...
                                @endif
                               @php
                                    $airCost = $shippingCost?->air_cost ?? 0;
                                    $seaCost = $shippingCost?->ship_cost ?? 0;
                                @endphp
                                    ...
                                    <div class="container mb-4">
                                        ...
                                        <div class="row row-cols-1 row-cols-md-2 g-3">
                                            ...
                                            <div class="col">
                                                <div class="shipping-option cursor-pointer p-1 bg-light border rounded h-100 active border-primary shadow"
                                                    data-type="air"
                                                    data-cost="{{ $airCost }}">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <svg class="shipping-icon" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                            viewBox="0 0 512 512" height="24" width="24"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            style="color: #167389;">
                                                            <path d="M256 48C141.31 48 48 141.31 48 256s93.31 208 208 208 
                                                                208-93.31 208-208S370.69 48 256 48zm108.25 138.29l-134.4 
                                                                160a16 16 0 01-12 5.71h-.27a16 16 0 01-11.89-5.3l-57.6-64a16 
                                                                16 0 1123.78-21.4l45.29 50.32 122.59-145.91a16 16 0 
                                                                0124.5 20.58z"></path>
                                                        </svg>
                                                        <span class="text-capitalize">By air</span>
                                                    </div>
                                                    <p class="mt-2 mb-0" style="font-size: 14px;">৳{{ number_format($airCost) }} /kg</p>
                                                </div>
                                            </div>

                                            <!-- By Sea -->
                                            <div class="col">
                                                <div class="shipping-option cursor-pointer p-1 bg-light border rounded h-100"
                                                    data-type="sea"
                                                    data-cost="{{ $seaCost }}">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <svg class="shipping-icon" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                        ...
                                                        <span class="text-capitalize">By sea</span>
                                                    </div>
                                                    <p class="mt-2 mb-0" style="font-size: 14px;">৳{{ number_format($seaCost) }} /kg</p>
                                                </div>
                                            </div>
                                ...
                                <div class="card mb-3">
                                    <div class="card-header p-2 bg-light d-flex justify-content-between align-items-center">
                                        <div>
                                            <strong>শিপিং চার্জ</strong><br>
                                            <span class="shpping_charge">{{ number_format($airCost, 2) }} /kg</span>
                                           <p class="shipingtext text-justify d-none text-red small">
                                               অর্ডার প্লেস করার পর আমাদের একজন প্রতিনিধি আপনার সঙ্গে যোগাযোগ করবেন উক্ত প্রোডাক্টটি সি শিপমেন্টের মাধ্যমে আনা যাবে কি না। নিশ্চিত হওয়ার আগে কোনো ধরনের পেমেন্ট করা থেকে বিরত থাকুন।
                                            </p>

                                        </div>
                                       <a href="#" class="text-primary small ml-2" data-toggle="modal" data-target="#shippingModalDetails">বিস্তারিত&gt;</a>
                                    </div>
                                    ...
                                    <div class="card-body p-0">
                                        <table class="table mb-0">
                                            <tr class="bg-light">
                                                <th class="text-left ">
                                                    From China  <img src="https://flagcdn.com/16x12/cn.png" alt="China"> 
                                                
                                                </th>
                                                <th  class="text-left">
                                                
                                                    To Bangladesh <img src="https://flagcdn.com/16x12/bd.png" alt="Bangladesh">
                                                </th>
                                            </tr>
                                            <tr>
                                                <td>Product Quantity</td>
                                                <td><span class="total_quantity">0.00</span></td>
                                            </tr>
                                            <tr>
                                                <td>Product Price</td>
                                                <td>৳<span class="sub_total_price">0.00</span></td>
                                            </tr>
                                            <tr>
                                                <td>Shipping Charge</td>
                                                <td class="shpping_charge">৳{{ number_format($airCost, 0) }} / ৳1100 Per Kg</td>
                                            </tr>
                                            <tr>
                                                <td>Total Cost</td>
                                                <td>৳<span class="total_price">0.00</span> + China Local Courier Charge & Shipping Charge</td>
                                            </tr>
                                            <tr>
                                                <td>Pay now (50%)</td>
                                                <td>৳<span class="pay_now">0.00</span></td>
                                            </tr>
                                            <tr>
                                                <td>Pay on Delivery</td>
                                                <td>৳<span class="pay_later">0.00</span> + China Local Courier Charge & Shipping Charge</td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <button  type="button"
                                                     ...
                                                     @auth  onclick="addToCart()" @else onclick="showLoginModal()" @endauth
                                                     disabled>
                                ...
                                <div class="mt-2">
                                     <p class="mb-1"><strong>Product Code:</strong> <span>{{$detailedProduct['Id']}}</span></p>
                                     <p class="mb-1 "><strong>Approximate Weight:</strong> <span
                                            class="total_weight">{{ $detailedProduct['ActualWeightInfo']['Weight'] }}</span> KG</p>
                            
                                    <span class="text-red">*** উল্লেখিত পণ্যের ওজন সম্পূর্ণ সঠিক নয়, আনুমানিক মাত্র। বাংলাদেশে আসার পর পণ্যটির প্রকৃত ওজন মেপে শিপিং চার্জ হিসাব করা হবে। ।</span>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card text-center p-3">
                            <div class="mb-2">
                                <i class="fas fa-store fa-2x text-primary"></i> <!-- Store Icon -->
                            </div>
                            <h6 class="mb-1">{{ $detailedProduct['VendorId'] }}</h6>
                            <small class="text-muted d-block mb-1">{{ $detailedProduct['VendorDisplayName'] }}</small>
                            <span class="badge bg-light text-dark mb-3">Seller Level: {{ $detailedProduct['VendorScore'] / 5 }}</span>
                            ...
                            <a href="{{ route('shop.visit', ['vendorId' => $detailedProduct['VendorId'], 'vendorName' => $detailedProduct['VendorName']]) }}"
                               class="btn btn-danger btn-sm px-4 rounded-pill">
                                Visit Store
                            </a>
                        </div>
                        <div class="card p-2">
                            <div class="card-body px-0 text-justify">
                                <h6 class="text-center border-bottom mb-3"><strong>শিপিং চার্জ</strong></h6>
                                <div class="mb-3">
                                    <strong>ক্যাটাগরিঃ এ - ৭০০ টাকা প্রতি কেজি</strong><br>
                                    প্রতি কেজি জুতা, ব্যাগ, জুয়েলারী, যন্ত্রপাতি, স্টিকার, ইলেকট্রনিক্স, কম্পিউটার এক্সেসরীস, সিরামিক, ধাতব, চামড়া, রাবার, প্লাস্টিক জাতীয় পন্য, ব্যাটারি ব্যাতিত খেলনা।
                                </div>
                                <div class="mb-3">
                                    <strong>ক্যাটাগরিঃ বি - ১১০০ টাকা প্রতি কেজি</strong><br>
                                    ব্যাটারি জাতীয় যেকোন পন্য, ডুপ্লিকেট ব্রান্ড বা কপি পন্য, জীবন্ত উদ্ভিদ, বীজ, রাসায়নিক দ্রব্য, নেটওয়ার্কিং আইটেম, ম্যাগনেট বা লেজার জাতীয় পন্য।
                                </div>
                                <div>
                                    <strong>ক্যাটাগরিঃ সি</strong><br>
                                    পোশাক বা যেকোন গার্মেন্টস আইটেম ৭৪০ টাকা, খাদ্য ১২০০ টাকা, ছাতা ৮০০, হিজাব/ওড়না ৮৫০ টাকা, পাউডার ১২০০, সানগ্লাস ৩৫০০, সি সি ক্যামেরা ১৫০০ টাকা, তরল পণ্য বা কসমেটিক্স ১১৫০ টাকা, শুধু ব্যাটারি বা পাওয়ার ব্যাংক ১৩৫০ টাকা, স্মার্ট ওয়াচ ১২০০ টাকা, সাধারণ ঘড়ি ১১০০ টাকা, Bluetooth হেডফোন ১১০০ টাকা।
                                </div>
                            </div>
                        </div>
                        <div class="row px-sm-3 ">
                            <div class="card p-0">
                                <div class="card-body px-0 text-justify">
                                <h6 class="text-center border-bottom mb-3"><strong>Similer Products</strong></h6>
                                @foreach (array_slice($SimilerProducts, 0, 5) as $key => $product)
                                    <div class="col-12 px-2">
                                        <div class="custom-product-box h-100">
...
<div class="modal fade" id="shippingModalDetails" tabindex="-1" role="dialog" aria-labelledby="shippingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="shippingModalLabel">শিপিং চার্জ</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <!-- Bootstrap 5: btn-close -->
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body text-justify">
          <strong>ক্যাটাগরিঃ এ - ৭০০ টাকা প্রতি কেজি</strong><br>
          প্রতি কেজি জুতা, ব্যাগ, জুয়েলারী, যন্ত্রপাতি, স্টিকার, ইলেকট্রনিক্স, কম্পিউটার এক্সেসরীস, সিরামিক, ধাতব, চামরা, রাবার, প্লাস্টিক জাতীয় পন্য, ব্যাটারি ব্যাতিত খেলনা।<br><br>
  
          <strong>ক্যাটাগরিঃ বি - ১১০০ টাকা প্রতি কেজি</strong><br>
          ব্যাটারি জাতীয় যেকোণ পন্য, ডুপ্লিকেট ব্রান্ড বা কপিঁ পন্য, জীবন্ত উদ্ভিদ, বীজ, রাসায়নীক দ্রব্য, নেটওয়ার্কিং আইটেম, ম্যাগনেট বা লেজার জাতীয় পন্য।<br><br>
  
          <strong>ক্যাটাগরিঃ সি</strong><br>
          পোশাক বা যেকোন গার্মেন্টস আইটেম ৭৪০ টাকা, খাদ্য ১২০০ টাকা, ছাতা ৮০০, হিজাব / ওড়না ৮৫০ টাকা, পাউডার ১২০০, সানগ্লাস ৩৫০০, সিসি ক্যামেরা ১৫০০, তরল পণ্য বা কসমেটিক্স ১১৫০, শুধু ব্যাটারি বা পাওয়ার ব্যাংক ১৩৫০, স্মার্ট ওয়াচ ১২০০, সাধারন ঘড়ি ১১০০, Bluetooth হেডফোন ১১০০ টাকা।
        </div>
...
//for showing shiping air cost
document.addEventListener('DOMContentLoaded', () => {
    const options = document.querySelectorAll('.shipping-option');
    const chargeEl = document.querySelector('.shpping_charge');
    ...
    const activeColor = '#167389';
    const inactiveColor = '#aaa';
    const shipNote = document.querySelector('.shipingtext');
    ...
    options.forEach(option => {
        option.addEventListener('click', () => {
            ...
            options.forEach(opt => {
                opt.classList.remove('active', 'border-primary', 'shadow');
                opt.querySelector('.shipping-icon').style.color = inactiveColor;
            });

            // Add active styles to selected option
            option.classList.add('active', 'border-primary', 'shadow');
            option.querySelector('.shipping-icon').style.color = activeColor;

            // Update cost display
            const cost = option.dataset.cost || 0;
            chargeEl.textContent = formatBDT(cost) + ' /kg';

             const type = option.dataset.type;
                if (type === 'sea') {
                    shipNote.classList.remove('d-none');
                } else {
                    shipNote.classList.add('d-none');
                }
                });
    });
});
                 ...
                 row.setAttribute('data-weight', actualWeightInfo
                           ...
                           // Clean and format the price
                            ...
                            if (stockQuantity === 0) {
                                ...
                                quantityCell.innerHTML = `
                                    <div class="input-group quantity-group">
                                        <button class="btn btn-primary decrement-btn px-2" type="button">-</button>
                                        <input type="text" class="form-control text-center quantity-input" value="0" style="padding: 0;">
                                        <button class="btn btn-primary increment-btn px-2" type="button">+</button>
                                    </div>
                                `;
                            }
...
function addSeeLessButton(matchingItems) {
                ...
                if (minQuantity > 0) {
                    ...
                    if (totalQuantity >= minQuantity) {
                        addToCartBtn.disabled = false; 
                         buyNowBtn.disabled = false;// Enable if total quantity is greater than or equal to minQuantity
                    } else {
                        addToCartBtn.disabled = true;
                        buyNowBtn.disabled = true;// Disable if total quantity is less than minQuantity
                    }
                } else {
                    // Fallback if minQuantity is invalid or 0
                    addToCartBtn.disabled = totalQuantity === 0; 
                     buyNowBtn.disabled = totalQuantity === 0;// Disable if totalQuantity is 0
                }
            ...
            function updateSummary() {
                ...
                quantityInputs.forEach(input => {
                    ...
                    totalWeight += currentQuantity * weight;
                     ...
                     payNow = subTotalPrice * 0.50;
                     payLater = subTotalPrice - payNow;
                });
                ...
                document.querySelector('.pay_now').textContent = payNow.toFixed(0);
                document.querySelector('.pay_later').textContent = payLater.toFixed(0);
                            }
    ...
    <script>
        ...
        function resetValues() {
           ...
           document.querySelector('.pay_now').textContent = '0.00';
           document.querySelector('.pay_later').textContent = '0.00';
        }
    </script>
