                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-7 p-4 p-lg-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="fs-20 fs-md-24 fw-700 text-danger">{{ translate('Create an account')}}</h1>
                                    </div>
                                    <!-- Register form -->
                                    <div class="pt-3 pt-lg-4">
                                        <div class="">
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                                ...
                                                <!-- Submit Button -->
                                                <div class="mb-4 mt-4">
                                                    <button type="submit" class="btn btn-danger btn-block fw-600 rounded-4">{{  translate('Create Account') }}</button>
                                                </div>
                                            </form>
