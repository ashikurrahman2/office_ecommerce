            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="text-center py-4 mb-0">
                        ...
                        <p class="fs-13 text-dark">{{  translate('A copy or your order summary has been sent to') }} <strong>{{ json_decode($first_order->shipping_address)->email }}</strong></p>
                    </div>
                    <!-- Order Summary -->
                    <div class="mb-4 bg-white p-4 border">
                        <h5 class="fw-600 mb-3 fs-16 text-dark pb-2 border-bottom">{{ translate('Order Summary')}}</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table fs-14 text-dark">
                                    <tr>
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 pr-0 py-2">{{ single_price($combined_order->grand_total_without) }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="card shadow-none border rounded-0">
                            <div class="card-body">
                                ...
                                <div class="text-center py-1 mb-4">
                                    <h2 class="h5 fs-20">{{ translate('Order Code:')}} <span class="fw-700 text-danger">{{ $order->code }}</span></h2>
                                </div>
                                <!-- Order Details -->
                                <div>
                                    <h5 class="fw-600 text-dark mb-3 fs-16 pb-2">{{ translate('Order Details')}}</h5>
                                    <!-- Product Details -->
                                    <div>
                                        <table class="table table-responsive-md text-dark fs-14">
                                            <thead>
                                                <tr>
                                                    <th class="opacity-60 border-top-0 pl-0">#</th>
                                                    <th class="opacity-60 border-top-0" width="30%">{{ translate('Product')}}</th>
                                                    <th class="opacity-60 border-top-0">{{ translate('Attribute')}}</th>
                                                    ...
                                                    <th class="text-right opacity-60 border-top-0 pr-0">{{ translate('Total')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                                ...
                                                <tbody>
                                                    ...
                                                    {{-- <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td class="text-right border-top-0 pr-0 py-2">
                                                            <span class="fw-600">{{ single_price($order->coupon_discount) }}</span>
                                                        </td>
                                                    </tr>
                                                    <!-- Total -->
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th class="py-2"><span class="fw-600">{{ translate('Paid Total')}}</span></th>
                                                        <td class="text-right pr-0">
