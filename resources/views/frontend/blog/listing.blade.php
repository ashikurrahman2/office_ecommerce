                            ...
                            <div class="card mb-4 overflow-hidden shadow-none border rounded-0 hov-scale-img p-3">
                                ...
                                <div class="py-3">
                                    <h2 class="fs-16 fw-700 mb-3 h-35px text-truncate-2">
                                        <a href="{{ url("blog").'/'. $blog->slug }}" class="text-reset hov-text-danger" title="{{ $blog->title }}">
                                            {{ $blog->title }}
                                        </a>
                                    </h2>
                                    ...
                                    <div class="mt-3 text-danger">
                                        <a href="{{ url("blog").'/'. $blog->slug }}" class="fs-14 fw-700 text-danger has-transition d-flex align-items-center hov-column-gap-1">
                                ...
                                <div class="bg-white border mb-3 mx-3 mx-xl-0">
                                    ...
                                    <div class="p-3 aiz-checkbox-list">
                                        ...
                                        <label class="aiz-checkbox mb-3">
                                            ...
                                            <span class="fs-14 fw-400 text-dark has-transition hov-text-danger">{{ $category->category_name }}</span>
                                        </label>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="">
                                        <h2 class="fs-14 fw-700 mb-2 mb-xl-3 h-35px text-truncate-2">
                                            <a href="{{ url("blog").'/'. $recent_blog->slug }}" class="text-reset hov-text-danger" title="{{ $recent_blog->title }}">
                                                {{ $recent_blog->title }}
                                            </a>
                                        </h2>
                                        <div>
