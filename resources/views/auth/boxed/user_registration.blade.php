                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            ...
                            <!-- Right Side -->
                            <div class="col-lg-8 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
            
                                <!-- Titles -->
                                <div class="text-center text-lg-left">
                                    <h1 class="fs-20 fs-md-24 fw-700 text-danger" style="text-transform: uppercase;">{{ translate('Create an account')}}</h1>
                                </div>
                                    ...
                                    <div class="">
                                        <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="fs-12 fw-700 text-dark">{{  translate('Full Name') }}</label>
                                            ...
                                            @if (addon_is_activated('otp_system'))
                                                ...
                                                <div class="form-group text-right">
                                                    <button class="btn btn-link p-0 text-danger" type="button" onclick="toggleEmailPhone(this)"><i>*{{ translate('Use Email Instead') }}</i></button>
                                                </div>
                                            @else
                                                <div class="form-group">
                                                    <label for="email" class="fs-12 fw-700 text-dark">{{  translate('Email') }}</label>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="text-right mt-1">
                                                    <span class="fs-12 fw-400 text-gray-dark">{{ translate('Password: 6+ characters, uppercase & lowercase') }}</span>
                                                </div>
                                            ...
                                            <!-- password Confirm -->
                                            <div class="form-group">
                                                <label for="password_confirmation" class="fs-12 fw-700 text-dark">{{  translate('Confirm Password') }}</label>
                                                <div class="position-relative">
                        ...
                        <div class="mt-3 mr-4 mr-md-0">
                            <a href="{{ route('home') }}" class="ml-auto fs-14 fw-700 d-flex align-items-center text-danger" style="max-width: fit-content;">
