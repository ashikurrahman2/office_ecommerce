                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                                ...
                                <div class="text-center text-lg-left">
                                    <h1 class="fs-20 fs-md-20 fw-700 text-danger" style="text-transform: uppercase;">{{ translate('Reset Password') }}</h1>
                                    <h5 class="fs-14 fw-400 text-dark">
                                        {{ translate('Enter your code, new password and confirm password.') }}
                                    </h5>
                                </div>
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default" role="form" action="{{ route('password.update') }}" method="POST">
                                            ...
                                            <!-- Code -->
                                            <div class="form-group">
                                                <input id="code" type="number" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="code" value="" placeholder="{{translate('Code')}}" required autofocus>
