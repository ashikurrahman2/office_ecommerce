                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                   ...
                                   <a href="javascript:void(0)"
                                    ...
                                    <i class="fa fa-truck"></i> Add Tracking Number
                                    </a>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title h6">Add Tracking Number</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      </div>

      <div class="modal-body">
        <input type="hidden" name="order_id" id="tracking_order_id">
        <input type="text" name="tracking_code" id="tracking_code_input" class="form-control" placeholder="Tracking Code">
...
function save_tracking_code() {
    ...
    if (!orderId || !trackingCode) {
        alert('Order ID and tracking code are required.');
        return;
    }

    $.ajax({
        url: '{{ route("orders.update_tracking_code") }}', // Update with your actual route
        method: 'POST',
