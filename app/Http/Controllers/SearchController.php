...
{//dd('ok');
   ...
   public function imageSearch(Request $request)
        {
            // On POST (upload), process the image
            if ($request->isMethod('post')) {
                ...
                // ✅ Redirect to GET with imageUrl in the query string
                return redirect()->route('search.image', ['imageUrl' => $imageUrl]);
            }
        
            // GET: Get imageUrl from query string
            $imageUrl = $request->query('imageUrl');
        
            // If imageUrl is not set, return error
            if (!$imageUrl) {
