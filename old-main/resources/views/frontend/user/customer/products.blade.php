    ...
    <div class="row gutters-16 mb-2">
        ...
        <div class="col-md-4 mx-auto mb-4">
            <div class="text-center bg-light d-block p-4 h-100 border">
                ...
                @endif
                <a href="{{ route('customer_packages_list_show') }}" class="text-danger hov-text-dark fs-14 fw-700">
                ...
                <tbody class="fs-14">
                    ...
                    <tr>
                        ...
                        <td class="text-dark" style="vertical-align: middle;">
                            <a href="{{ route('customer.product', $product->slug) }}" class="text-reset hov-text-danger d-flex align-items-center">
