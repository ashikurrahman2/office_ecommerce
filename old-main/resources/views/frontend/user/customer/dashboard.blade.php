...
@section('panel_content')
        ...
        <div class="col mb-4">
            <div class="h-100">
                <div class="row h-100 @if(get_setting('wallet_system') != 1 && addon_is_activated('club_point')) row-cols-md-2 @endif row-cols-1">
                    <!-- Expenditure summary -->
                    <div class="col">
                        <div class="p-4 bg-danger @if(!addon_is_activated('club_point')) h-100 @endif" style="margin-bottom: 2rem;">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="p-4 border h-100">
                ...
                @if($customer_package != null)
                    ...
                    <p class="fs-14 fw-700 mb-3 text-danger">{{ translate('Current Package') }}: {{ $customer_package->getTranslation('name') }}</p>
                ...
                @else
                    <span class="fs-14 fw-700 mb-4 text-danger">{{translate('Package Not Found')}}</span>
                @endif
    ...
    <div class="row align-items-center mb-2 mt-1">
        ...
        <div class="col-6 text-right">
            <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-danger animate-underline-primary" href="{{ route('wishlists.index') }}">{{ translate('View All') }}</a>
        </div>
    </div>
    @php
                ...
                @if ($wishlist->product != null)
                    <div class="aiz-card-box col py-3 text-center border-right border-bottom has-transition hov-shadow-out z-1" id="wishlist_{{ $wishlist->id }}">
                        ...
                        <h5 class="fs-14 mb-0 lh-1-5 fw-400 text-truncate-2 mb-3">
                            <a href="{{ route('product', $wishlist->product->slug) }}" class="text-reset hov-text-danger"
                                title="{{ $wishlist->product->getTranslation('name') }}">{{ $wishlist->product->getTranslation('name') }}</a>
                        </h5>
                        <!-- Price -->
                        <div class="fs-14">
                            <span class="fw-600 text-danger">{{ home_discounted_base_price($wishlist->product) }}</span>
