                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-7 p-4 p-lg-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="fs-20 fs-md-24 fw-700 text-danger">{{ translate('Welcome Back !')}}</h1>
                                    ...
                                    <div class="pt-3 pt-lg-4">
                                        <div class="">
                                            <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                                ...
                                                <!-- Submit Button -->
                                                <div class="mb-4 mt-4">
                                                    <button type="submit" class="btn  btn-danger btn-block fw-700 fs-14 rounded-4">{{  translate('Login') }}</button>
                                                </div>
                                            </form>
