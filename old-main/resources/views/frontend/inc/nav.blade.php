            ...
            <div class="col-lg-6 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start align-items-center mb-0">
                    ...
                    <li class="list-inline-item border-right pr-2">
                        <a href="https://localhost/cpl/cpl-main/contact"
    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center btn-primary  p-2 rounded" id="category-menu-bar"
                    ...
                    <a class="d-block py-5px mr-lg-3 ml-0" href="{{ route('home') }}">
                        ...
                        @if ($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                class="mw-100 h-50px h-md-40px pl-3" height="200" width="75">
                        @else
