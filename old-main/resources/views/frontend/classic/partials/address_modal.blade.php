                        ...
                        <div class="row">
                           ...
                           <div class="col-md-10">
                                <div class="input-group">
                                    <span class="input-group-text rounded-0">+88</span>
                                    <input type="text" class="form-control rounded-0" placeholder="{{ translate('Enter your phone number') }}" name="phone" value="" required>
                                </div>
                            </div>
