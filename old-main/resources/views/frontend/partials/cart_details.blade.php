                                ...
                                <li class="list-group-item px-0">
                                    <div class="row gutters-5 align-items-center">
                                        ...
                                        <div class="col-md col-5 order-4 order-md-0 my-3 my-md-0">
                                            ...
                                            <span class="fw-700 fs-16 text-danger">{{ single_price(cart_product_price($cartItem, $product, false) * $cartItem['quantity']) }}</span>
                                        </div>
                                        <!-- Remove From Cart -->
                                        <div class="col-md-auto col-6 order-5 order-md-0 text-right">
                                            <a href="javascript:void(0)" onclick="removeFromCartView(event, {{ $cartItem['id'] }})" class="btn btn-icon btn-sm btn-soft-primary bg-soft-warning hov-bg-danger btn-circle">
