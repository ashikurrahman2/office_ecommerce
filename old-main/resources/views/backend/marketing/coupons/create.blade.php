                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="type" id="coupon_type" class="form-control aiz-selectpicker" onchange="coupon_form()" required>
                            ...
                            @if (!$all_product_base_exist)                                
                                <option value="all_product_base" @if (old('type') == 'all_product_base') selected @endif>{{translate('For All Products')}}</option>
                            @endif

                            @if (!$welcome_base_exists)
