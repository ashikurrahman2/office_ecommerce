                    ...
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                                <!-- Site Icon -->
                                <div class="mb-3 mx-auto mx-lg-0" style="height: 50px; width:80px">
                                    <img src="{{ uploaded_asset(get_setting('site_icon')) }}" alt="{{ translate('Site Icon')}}" class="img-fit h-100">
                                </div>

                                <!-- Titles -->
                                <div class="text-center text-lg-left">
                                    <h1 class="fs-20 fs-md-20 fw-700 text-danger" style="text-transform: uppercase;">{{ translate('Forgot password?') }}</h1>
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default" role="form" action="{{ route('password.email') }}" method="POST">
                                            ...
                                            <!-- Submit Button -->
                                            <div class="mb-4 mt-4">
                                                <button type="submit" class="btn btn-danger btn-block fw-700 fs-14 rounded-0">{{ translate('Send Password Reset Link') }}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
