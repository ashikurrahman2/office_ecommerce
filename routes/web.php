...
Route::get('/login/otp', [OTPVerificationController::class, 'showLoginWithOtpForm'])->name('otp.login.form');
Route::post('/login/otp/send', [OTPVerificationController::class, 'sendOtpForLogin'])->name('otp.login.send');
Route::post('/login/otp/verify', [OTPVerificationController::class, 'verifyOtpLogin'])->name('otp.login.verify');
