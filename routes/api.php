...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    //Get from OTecommerce
    Route::controller(OTAPIController::class)->group(function () {
        Route::get('/show-all-categories', 'showCategories')->name('all_category_from_api');
        Route::get('/two-level-categories', 'showTwoLevelCategories');
        Route::get('/three-level-categories', 'showThreeLevelCategories');
    });
});
